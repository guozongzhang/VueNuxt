              ...
              div.input-group
                span.input-group-prepend
                  span.input-group-text 
                    | 名称： 
                    span.nut-null *
                input.form-control(type="text" v-model="info.field_name" placeholder="请输入名称")
            div.form-group
              div.input-group
                span.input-group-prepend
                  span.input-group-text 
              ...
              div.input-group
                span.input-group-prepend
                  span.input-group-text 
                    | 排序：
                    span.nut-null *
                input.form-control(type="text" v-model="info.field_order" placeholder="请输入排序号")
            div.form-group
              div.input-group
                span.input-group-prepend
  ...
  export default {
    ...
    methods: {
      ...
      init: async function() {
        ...
        API.GET('classes/furniture_field_types', {id: id}).then(function (response) {
      ...
      commitBtn: function () {
        ...
        API.PUT('classes/furniture_field_types', model.info).then(function (response) {
