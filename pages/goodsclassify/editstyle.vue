  ...
  export default {
    ...
    methods: {
      ...
      init: async function() {
        ...
        API.GET('classes/furniture_styles', {id: id}).then(function (response) {
      ...
      commitBtn: function () {
        ...
        API.PUT('classes/furniture_styles', model.info).then(function (response) {
