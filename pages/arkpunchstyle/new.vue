      ...
      div.box-header.row
        ...
        div.col-md-12(v-for="(mo, num) in motherArr")
          ...
          div.col-md-3
            div.form-group
              div.input-group
                select.form-control(v-model="mo.type_poi_c2m_part_simple_type" @change="getThirdType(mo)")
                  option(value="-1") 请选择
        ...
        div.col-md-12(v-for="(son, num) in sonArr")
          ...
          div.col-md-3
            div.form-group
              div.input-group
                select.form-control(v-model="son.type_poi_c2m_part_simple_type" @change="getThirdType(son)")
                  option(value="-1") 请选择
                  option(v-for="item in twoArr" v-bind:value="item.id") {{item.name}}
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 2018-07-03 yuguo
      // obj(object) 当前操作对象
      getThirdType: async function (obj) {
      ...
      commitBtn: function () {
        ...
        API.POST('functions/hole/technology_hole', param).then((msg) => {
